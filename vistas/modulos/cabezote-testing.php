...
//============================================
// MODO TESTING - DATOS HARDCODEADOS
//============================================
$clavePublicaMercadoPago = 'TEST-9e420918-959d-45dc-a85f-33bcda359e78';
$accesTokenMercadoPago = 'TEST-3927436741225472-082909-b379465087e47bff35a8716eb049526a-1188183100';

// Cliente hardcodeado para testing
$clienteMoon = [
    'id' => 1,
    'nombre' => 'Cliente de Prueba Moon POS',
    'email' => 'prueba@moonpos.com',
    'telefono' => '11-1234-5678'
];

// Datos de cobro hardcodeados (ESTRUCTURA CORRECTA)
$datosCobro = [
    'monto' => 15000.00,         // ← Clave correcta: 'monto'
    'recargo_aplicado' => 10,    // 10% de recargo simulado
    'descripcion' => 'Sistema Moon POS - Plan Estándar (TESTING)',
    'mostrar_modal' => true,
    'fijar_modal' => false,
    'estado_barra' => 'style="background: linear-gradient(135deg, #ffc107 0%, #ff9800 100%);"',
    'mensaje' => '<span style="color: #fff; padding: 10px;"><i class="fa fa-exclamation-triangle"></i> <strong>MODO TESTING:</strong> Pago pendiente de $15,000</span>'
];

$muestroModal = true;  // Forzar modal para testing
$fijoModal = false;
$estadoClienteBarra = $datosCobro['estado_barra'];
$mensajeCliente = $datosCobro['mensaje'];
$abonoMensual = $datosCobro['monto'];  // ← Usar 'monto' no 'monto_final'
